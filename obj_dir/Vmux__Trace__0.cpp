...
void Vmux___024root__trace_chg_0_sub_0(Vmux___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelf->mux_tb__DOT__a));
    bufp->chgBit(oldp+1,(vlSelf->mux_tb__DOT__b));
    bufp->chgBit(oldp+2,(vlSelf->mux_tb__DOT__sel));
    bufp->chgBit(oldp+3,(((IData)(vlSelf->mux_tb__DOT__sel)
